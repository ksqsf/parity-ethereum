...
use bench_storage::BenchStorageCommand;
...
pub enum Cmd {
    BenchStorage(BenchStorageCommand),
    Run(RunCmd),
    Version,
    Account(AccountCmd),
...
impl Configuration {
	...
	let cmd = if self.args.flag_version {
	    Cmd::Version
	} else if self.args.cmd_bench_storage {
            Cmd::BenchStorage(BenchStorageCommand {
                tx_file: self.args.arg_tx_file.unwrap(),
                db_dir: self.args.arg_db_dir.unwrap(),
                txs_to_process: None,
                skip_bytes: None,
            })
